    ...
    <div id="main" className="wrapper style1">
      <div className="container">
        <header className="major">
          <h2>About Rosa Lin</h2>
          <p>
            A Designer,a Adventurer.
          </p>
        </header>

        <section>
          <h3>林 幸蓉 Hsing_Jung,Lin</h3>
          <p>
          1994年　台湾台南市生まれ。
2017年日本京都工芸繊維大学デザイン経営学部で留学プログラム修了。 2018年台湾大同大学大学院インダストリアルデザイン学専攻修士課程修了。
台湾のデザイン会社事務所に1年勤めた後、自分に新たな環境を挑戦したいと思い、2019年に日本へ。
アパレル業界を経て、Brionacに入社。
趣味は、日常中の非日常を発見、色々な出会いを楽しむこと。 最近の楽しみは季節ごとの食材での料理作り。
          </p>
